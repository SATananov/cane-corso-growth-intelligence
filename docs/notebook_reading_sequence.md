...
19. `notebooks/11_public_image_dataset_class_availability_audit.ipynb`
20. `notebooks/12_first_public_image_dataset_candidate_download_guide.ipynb`
21. `notebooks/13_local_stanford_dogs_inspection_baseline_class_selection.ipynb`
22. `notebooks/14_stanford_dogs_local_download_real_class_inspection.ipynb`
